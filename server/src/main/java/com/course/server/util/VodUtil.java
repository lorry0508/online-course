...
//        request.setCoverURL("http://vod.aliyun.com/test_cover_url.jpg");
        ...
        request.setTemplateGroupId("c5e562d39fccd5b6ab675eaccd87c23a");
    ...
    public static void main(String[] argv) {
        //您的AccessKeyId
        String accessKeyId = "LTAI5tRFPErLGzxWcuduSRMh";
        //您的AccessKeySecret
        String accessKeySecret = "2sGNbgBMZv7zBBK9CadiOyWWKBcPem";
        //需要上传到VOD的本地视频文件的完整路径，需要包含文件扩展名
        String localFile = "D:\\study\\course-online\\springCloud\\course-online\\admin\\public\\static\\image\\小节视频\\test.mp4";
        try {
            // 初始化VOD客户端并获取上传地址和凭证
